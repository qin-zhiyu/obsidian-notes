...
To view the backlinks for the active note, click the **Backlinks** ( ![obsidian-icon-links-coming-in.svg > icon](https://publish-01.obsidian.md/access/f786db9fac45774fa4f0d8112e232d67/Attachments/icons/obsidian-icon-links-coming-in.svg)) tab in the right sidebar.
...
Files matching your [Excluded files](https://help.obsidian.md/settings#Excluded%20files) patterns will not appear in Unlinked mentions.
